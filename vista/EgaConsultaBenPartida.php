...
<form action='../control/ATPRconsultaEgaBenef.php' method='post'>
    <select name="type">
        <option value="egadocumento">Cabecera C31</option>
        <option value="egapartida">Estructura Programatica(Partidas)</option>
        <option value="egarespaldo">Documento Respaldo</option>
