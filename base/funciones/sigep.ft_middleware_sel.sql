CREATE OR REPLACE FUNCTION sigep.ft_middleware_sel (
...
/**************************************************************************
 SISTEMA:		Sigep
 FUNCION: 		sigep.ft_middleware_sel
...
#ISSUE				FECHA				AUTOR				DESCRIPCION
 #0				10-01-2024 12:35:55								Funcion que devuelve conjuntos de registros de las consultas relacionadas con la tabla ''sigep.tservice_request''
 #
 ***************************************************************************/
...
BEGIN
	...
	v_nombre_funcion = ''sigep.ft_middleware_sel'';
	...
	***********************************/
	...
	if(p_transaccion=''SIG_SERVICE_SEL'')then
...
ALTER FUNCTION sigep.ft_middleware_sel (p_administrador integer, p_id_usuario integer, p_tabla varchar, p_transaccion varchar)
  OWNER TO postgres;