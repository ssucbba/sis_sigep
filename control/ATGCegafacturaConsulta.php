<?php
/**
*@file ATGCegafacturaConsulta.php
*@author  (breydi.vasquez)
*@date 11-10-2018
*@description Archivo consulta de Facturas Sigep 
*/
...
if ($err) {
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => "http://sigeppre-wl12.sigma.gob.bo/ejecucion-gasto/api/cola/ega_facturas/" . $_GET["cola_id"],
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
