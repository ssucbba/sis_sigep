<?php
/**
 *@file cuentalibreta.php
 *@author  (RZABALA)
 *@date 09-10-2018
 *@description Asigna Banco, Cuenta y Libreta Origen del C-31
 *                con imputación presupuestaria según la fuente y el
 *                organismo, se mantiene las condiciones para la asignación
 *                via aplicación.
 */
...
$payload = $jsonConverter->encode([
    ...
    'idOrganismo' => null,
    'bancoOrigen' => 1004,
    'cuentaOrigen' => "3987069001",
    'libretaOrigen' => "00578019201"
]);
...
if ($err) {
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://sigeppruebas-wl12.sigma.gob.bo/ejecucion-gasto/api/v1/egacuentalibreta",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
