...
curl_setopt_array($curl, array(
    CURLOPT_URL => "https://sigep.sigma.gob.bo/rsseguridad/apiseg/token?grant_type=refresh_token&client_id=0&redirect_uri=%2Fmodulo%2Fapiseg%2Fredirect&client_secret=0&refresh_token=FEA520426600:UYT2OfKKM4Fv7WVwoDUcelpKU0aAC0oO1hgLpqL7ax7WluPLFDnZdGd2KEw5LHDngBq8Q0gaYbEWVKCq6KMzeLm0c7BPD75Pqhgs",
...
if ($err) {
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://sigep.sigma.gob.bo/rsclasificadores/api/v1/presupuestogto/vigentes?gestion=2022&idEntidad=494&idDa=15&idUe=9957&idCatprg=762887&idFuente=12&idOrganismo=16&idObjeto=95&idEntTransferencia=1",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
