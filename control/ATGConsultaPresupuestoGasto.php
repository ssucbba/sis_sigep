...
curl_setopt_array($curl, array(
    CURLOPT_URL => "https://sigep.sigma.gob.bo/rsseguridad/apiseg/token?grant_type=refresh_token&client_id=0&redirect_uri=%2Fmodulo%2Fapiseg%2Fredirect&client_secret=0&refresh_token=RZG440350700:C4MhM3WnZOzzVx2NPTddwOQucSzxW8Qr33BPo70bP8vWSFbUgkIzBJTGU6fB2Q3aYgElbfNMWEPOWqfQxh7Kl1TgdNwAo8kpsdrW",
...
if ($err) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_URL => "https://sigep.sigma.gob.bo/rsclasificadores/api/v1/presupuestogto/vigentes?gestion=2021&id_entidad=494&id_da=15&id_ue=15&id_catprg=762887&id_fuente=12&id_objeto=73",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
