...
class ACTRequestParam extends ACTbase{    
	...
	function listarRequestParam(){
        ...
        if ($this->objParam->getParametro('id_sigep_service_request') != '') {
            $this->objParam->addFiltro("reqpar.id_sigep_service_request = ". $this->objParam->getParametro('id_sigep_service_request'));
        }
