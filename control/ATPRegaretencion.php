<?php
/**
*@file ATPRegaretencion.php
*@author  (breydi.vasquez)
*@date 11-10-2018
*@description Archivo Action para Crear Retenciones Sigep 
*/
...
if ($err) {
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://sigeppruebas-wl12.sigma.gob.bo/ejecucion-gasto/api/v1/egaretencion",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
