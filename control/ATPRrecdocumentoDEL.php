...
curl_setopt_array($curl, array(
    ...
    CURLOPT_URL => "https://sigep.sigma.gob.bo/rsseguridad/apiseg/token?grant_type=refresh_token&client_id=0&redirect_uri=%2Fmodulo%2Fapiseg%2Fredirect&client_secret=0&refresh_token=JJM445373800:cXrS6J0FKsLNe5UFlMY2sEPtvLyKqlgctSVD9w1CfOWNJ9A0Sn2M9AAW0xT1ChJhcXd7WtJgEUQ7xXKkrtDm5tb7clruBwxNOpxo",
...
if ($err) {
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://sigep.sigma.gob.bo/rsrecursos/api/v1/recursoscip",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
    ...
    $response = curl_exec($curl);//var_dump(curl_getinfo($curl));
    $err = curl_error($curl);
