<?php
/**
*@file ATGCegaretencion.php
*@author  (breydi.vasquez)
*@date 11-10-2018
*@description Archivo Crear Retenciones Sigep  
*/
...
if ($err) {
    ...
    $curl = curl_init();
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://sigeppruebas-wl12.sigma.gob.bo/ejecucion-gasto/api/cola/ega_retenciones/" . $_GET["cola_id"],
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
