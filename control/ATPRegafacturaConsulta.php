<?php
/**
*@file ATPRegafacturaConsulta.php
*@author  (breydi.vasquez)
*@date 11-10-2018
*@description Archivo 
*Respuesta Método Consulta de Colas para creación, modificación y eliminación  factura sigep. 
*/
...
if ($err) {
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "http://sigeppre-wl12.sigma.gob.bo/ejecucion-gasto/api/v1/egafactura",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
