...
curl_setopt_array($curl, array(
    ...
    CURLOPT_URL => "https://sigep.gob.bo/rsseguridad/apiseg/token?grant_type=refresh_token&client_id=0&redirect_uri=%2Fmodulo%2Fapiseg%2Fredirect&client_secret=0&refresh_token=LCC798168100:dIFnBlDnWCzCF1QuHmMJfpNc0rliPNccO5AuJFNO1ew5eXx6jlJTjD5pBK8CtkN5hjDnjSVtokWFs5exwUounG3PVA9huVGbQTF1",
...
if ($err) {
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "https://sigep.gob.bo/ejecucion-gasto/api/v1/egadocumento",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
