...
DESCRIPCION:    Modifica los importes de distribución de beneficiarios-partidas del C-31,
 *              se mantiene las condiciones para la modificación de importes via aplicación.
 * ********************************************************/
...
if ($err) {
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "http://sigeppre-wl12.sigma.gob.bo/ejecucion-gasto/api/v1/egabenpartida",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
