...
METHOD: 		PUT (Asincrono)
AUTOR: 		    RZABALA
FECHA:	        09-10-2018 09:09:45
DESCRIPCION:    Modifica los importes de distribución de beneficiarios-multas
 * del C-31, se mantiene las condiciones para la modificación de importes via aplicación.
 * ********************************************************/
...
if ($err) {
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "http://sigeppre-wl12.sigma.gob.bo/ejecucion-gasto/api/v1/egabenmulta",
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => "",
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 30,
